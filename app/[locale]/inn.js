    ...
    <animate
      ...
      <div className="center-block container" id="effects" style={{width: "80vw"}} effects={effects}>
        <div className="row effect">
          ...
          <EffectValue label={ t("volume_value_label") } id="volumevalue" defaultValue={10} change={changeVolumeValue} min={-1000} max={1000} trueBypass={isVolume} setTrueBypass={setIsVolume}/>
        </div>
        <div className="row effect">
          {/* <button className='center-block p-0 arrow-sign' onClickCapture={()=>{handlePositionChange(distortion,-1)}}>↑</button> */}
          ...
          <EffectValue label={ t("distortion_value_label") } id="distortionvalue" defaultValue={5} change={changeDistortionValue} min={0} max={10000} trueBypass={isDistortion} setTrueBypass={setIsDistortion}/>
          {/* <button className='center-block p-0 arrow-sign' onClickCapture={()=>{handlePositionChange(distortion,1)}}>↓</button> */}
        </div>
        <div className="row effect">
          <EffectToggle label={ t("gain_label") } id="gain" checked={false} change={addGain} trueBypass={isGain} setTrueBypass={setIsGain}/>
          <EffectValue label={ t("gain_value_label") } id="gainvalue" defaultValue={20} change={changeGainValue} min={0} max={3.4028234663852886e+38.fromExponent()} trueBypass={isGain} setTrueBypass={setIsGain}/>
        </div>
        <div className="row effect">
